...
* [**BatchNorm2d**](https://pytorch.org/docs/stable/generated/torch.nn.BatchNorm2d.html) - Applies Batch Normalization over a 4D input, sclicing through *C* and computing statistics such as mean ($`\mu`) and variance () on *(N,H,W)* slices.
